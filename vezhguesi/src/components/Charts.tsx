...
const CustomGraph: React.FC = () => {
    ...
    return (
        <div className="bg-[#ffff] p-8 rounded-lg shadow-lg md:w-4/5 w-full">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    ...
                    className="text-xs px-6 py-2  text-black font-bold rounded-lg  transition-all duration-200"
                >
            ...
            {/* Metrics Display */}
            <div className="text-black mt-6 flex justify-between">
